        ...
        >
          <Tabs defaultValue="all" value={currentTab} onValueChange={handleTabChange} className="w-full">
            <TabsList className="w-full flex scroll-x-beautiful justify-start items-center bg-white px-3 pt-8 pb-10 gap-1.5 rounded-2xl shadow-sm mb-6 border border-gray-100">
              ...
              <TabsTrigger value={ORDER_STATUS.PENDING} className="flex-none py-3.5 px-4 text-sm font-medium text-gray-500 rounded-xl hover:text-brand-primary hover:bg-gray-50/80 data-[state=active]:bg-brand-primary/10 data-[state=active]:text-brand-primary data-[state=active]:font-bold transition-all duration-300 ease-in-out active:scale-95 cursor-pointer">
                <div className="flex items-center justify-center gap-2">
                  <FiFileText size={16} />
              ...
              <TabsTrigger value={ORDER_STATUS.PROCESSING} className="flex-none py-3.5 px-4 text-sm font-medium text-gray-500 rounded-xl hover:text-brand-primary hover:bg-gray-50/80 data-[state=active]:bg-brand-primary/10 data-[state=active]:text-brand-primary data-[state=active]:font-bold transition-all duration-300 ease-in-out active:scale-95 cursor-pointer">
                <div className="flex items-center justify-center gap-2">
                  <FiPackage size={16} />
              ...
              <TabsTrigger value={ORDER_STATUS.SHIPPING} className="flex-none py-3.5 px-4 text-sm font-medium text-gray-500 rounded-xl hover:text-brand-primary hover:bg-gray-50/80 data-[state=active]:bg-brand-primary/10 data-[state=active]:text-brand-primary data-[state=active]:font-bold transition-all duration-300 ease-in-out active:scale-95 cursor-pointer">
                <div className="flex items-center justify-center gap-2">
                  <FiTruck size={16} />
                  <span>Đang giao</span>
              ...
              <TabsTrigger value={ORDER_STATUS.COMPLETED} className="flex-none py-3.5 px-4 text-sm font-medium text-gray-500 rounded-xl hover:text-brand-primary hover:bg-gray-50/80 data-[state=active]:bg-brand-primary/10 data-[state=active]:text-brand-primary data-[state=active]:font-bold transition-all duration-300 ease-in-out active:scale-95 cursor-pointer">
                <div className="flex items-center justify-center gap-2">
              ...
              <TabsTrigger value={ORDER_STATUS.CANCELLED} className="flex-none py-3.5 px-4 text-sm font-medium text-gray-500 rounded-xl hover:text-brand-primary hover:bg-gray-50/80 data-[state=active]:bg-brand-primary/10 data-[state=active]:text-brand-primary data-[state=active]:font-bold transition-all duration-300 ease-in-out active:scale-95 cursor-pointer">
                <div className="flex items-center justify-center gap-2">
                  <FiXCircle size={16} />
                  <span>Đã hủy</span>
              ...
              <TabsTrigger value={ORDER_STATUS.CANCEL_REQUESTED} className="flex-none py-3.5 px-4 text-sm font-medium text-gray-500 rounded-xl hover:text-brand-primary hover:bg-gray-50/80 data-[state=active]:bg-brand-primary/10 data-[state=active]:text-brand-primary data-[state=active]:font-bold transition-all duration-300 ease-in-out active:scale-95 cursor-pointer">
                <div className="flex items-center justify-center gap-2">
